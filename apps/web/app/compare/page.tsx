...
function CompareView() {
  ...
  const rows = [
    ...
    },
    {
      ...
      fmt: (v: number, s: CompareSession) =>
        s.costUnknownCount > 0 ? '未定价' : `¥${v.toFixed(4)}`,
    },
  ];
    ...
    <div style={{ maxWidth: 1100, margin: '0 auto', padding: SP.xl }}>
      ...
      <Card pad={SP.sm}>
        <div
          style={{
            display: 'grid',
            gridTemplateColumns: `180px repeat(${sessions.length}, 1fr)`,
            gap: 0,
            fontSize: FS.sm,
          }}
        >
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: `0 1px 0 ${C.borderSoft}`,
                        background:
                          isNumeric && row.key !== 'cacheHitRate'
                    ...
                    >
                      <span
                        ...
                        style={{
                          color: C.text,
                          fontWeight:
                            row.key === 'totalCost' || row.key === 'totalTokens' ? 600 : 400,
                        }}
                      >
                      ...
                      {isNumeric &&
                        ...
                        numValues[i] === minVal &&
                        maxVal !== minVal && (
                          <span style={{ fontSize: FS.cap, marginLeft: 6, color: C.mute }}>
                            min
                          </span>
                        )}
                    </div>
