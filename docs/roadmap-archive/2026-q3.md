...
- implemented scope:
  ...
  - added a Project Profile section to the existing Stats workspace with project
    selection, loading/error/empty states, coverage labels, resource summary,
    tool reliability, and recent day trends
