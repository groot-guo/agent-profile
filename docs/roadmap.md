...
- steps:
  ...
  5. delete `server/trace.db`, re-scan
- affected: server/src/db.ts, server/src/routes.ts, packages/core/src/types.ts, packages/core/src/parser.ts
...
- affected: packages/core/src/scanner.ts, server/src/routes.ts
...
- affected: web/app/page.tsx, web/app/session/[id]/page.tsx
...
- affected: web/app/page.tsx, server/src/routes.ts (optional query param)
...
- affected: web/app/session/[id]/page.tsx, possibly core (sub-chain aggregation helper)
...
- affected: server/src/routes.ts, web/app/stats/page.tsx (new)
...
- affected: server/src/routes.ts, web/app/stats/page.tsx
...
- affected: server/src/llm-diagnoser.ts (new), server/src/routes.ts
...
- affected: server/src/db.ts, server/src/routes.ts
